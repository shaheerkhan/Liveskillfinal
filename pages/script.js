...
// Script for disappearing language dropdown when mobile nav open 
let navshowbtn = document.querySelector('.navbar-toggler')
let nav = document.querySelector('.dropdown-mobile');
navshowbtn.addEventListener('click', () => {
  nav.classList.toggle('hidedropdownmobile')
})